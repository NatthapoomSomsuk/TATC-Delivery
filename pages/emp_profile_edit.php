    ...
    <div class=" card w-100 h-100 rounded-0 border-0 rounded-top-5">
        <div class=" card-body">
            ...
            <form method="post" enctype="multipart/form-data">
                <p class=" fs-4 fw-medium m-0 text-center">Customer Employee Information </p>
                ...
                <div class=" hstack gap-3 my-2">
                    ...
                    <input type="text" name="bank" id="" value="<?= $mysql_profile_q_fatch['Bank'] ?>"
                        class=" form-control border-top-0 border-end-0 border-start-0 border-2 rounded-0 border-dark"
                        >
                </div>
                <div class=" hstack gap-3 my-2">
                    <p class=" fw-medium m-0 text-nowrap">เลขบัญชี</p>
                    <input type="text" name="banknumber" id="" value="<?= $mysql_profile_q_fatch['Bank_number'] ?>"
                        class=" form-control border-top-0 border-end-0 border-start-0 border-2 rounded-0 border-dark"
                        >
                </div>
                <div class=" hstack gap-3 my-2">
